...
## Excercise 8: Write a program to input the main salary(salary per day), allowance and number of working days in the month, print out the salary per month received according to the formula: 
